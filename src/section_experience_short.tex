...
\begin{experiences}
    ...
    {Now} {
        ...
        Regnora is an early-stage startup building AI-native compliance tooling for the life science industry.
        The platform helps compliance experts accelerate their work by leveraging AI to streamline regulatory processes that are traditionally manual and time-consuming.
        \newline \newline
        As CTO and co-founder, Thony is responsible for the full technical vision and execution of the product.
        His scope spans architecture, product development, and design.
        Drawing on his prior experience in the life science domain at ABC Labs, he is building a platform that meets the stringent regulatory requirements of the industry while delivering a modern and intuitive user experience.
        \newline
    }
    {React, Python, Pydantic, PostgreSQL, Redis, Grafana, Kubernetes, AI/LLM}
    \emptySeparator

    \experience
    {Q3 2024}
    {VP of Engineering}
    {LIMS \& Platform Development}
    {ABC Labs AB (via Thony Price AB)}
    {Q4 2025} {
        ...
        Having established themselves as a key player in Swedish laboratory services, they continued to grow and expand their offering beyond pandemic-related analyses.
        \newline \newline
        Thony returned to ABC Labs in a VP of Engineering role, this time through his own consultancy.
        He was tasked with leading the engineering team and driving the technical direction of the company.
        A key initiative was the development of an in-house Laboratory Information Management System (LIMS), a critical system for managing samples, workflows, and regulatory compliance in the life science domain.
        \newline \newline
        During his tenure, Thony grew the engineering team to twice its size while balancing the fast-paced demands of a startup with the strict regulatory requirements of the life science industry.
        He drove novel automation projects, managed infrastructure, and had a lasting impact on the team's engineering practices and culture.
        \newline
    }
    {Kubernetes, ArgoCD, GitOps, GitHub Actions, TypeScript, NestJS, PostgreSQL, Docker, Domain Driven Design, Event Sourcing, Stakeholder Management, Team Leadership}
    \emptySeparator
